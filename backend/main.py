...
app = FastAPI(
    title="backupguardian-1",
    description="BackupGuardian 1: Automated backup solution for databases and file systems",
    version="1.0.0",
)
...
@app.get("/health")
def health_check():
    return {"status": "healthy", "service": "backupguardian-1"}
